...
const moviesWithShortTitle = movies.filter(
  (shortName) => shortName.title.length < 5
);
console.log(moviesWithShortTitle);

//2.
const moviesWithLongTitle = movies.filter(
  (longName) => longName.title.length > 5
);
console.log(moviesWithLongTitle);

//3.
const moviesMadeInEighties = movies
  .filter((movies) => movies.year >= 1980)
  .filter((movies) => movies.year >= 1989);
console.log(moviesMadeInEighties);
...
const moviesRatedThanSix = movies
  .filter((movies) => movies.rating > 6)
  .map((movies) => movies);
console.log(moviesRatedThanSix);
...
// //9.
const movieCounts = movies.reduce((acc, movie) => {
  return acc + 1;
}, 0);
